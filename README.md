...
- Si renombraste canciones recientemente, el bot ahora prueba búsqueda por el texto exacto y en minúsculas para mejorar compatibilidad con datos nuevos y legacy.
